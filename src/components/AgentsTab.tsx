  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      ...
      <div className="lg:col-span-1 lg:sticky lg:top-6 lg:h-fit">
        <Card className="bg-slate-900/50 border-cyan-400/30 flex flex-col lg:max-h-[calc(100vh-3rem)] overflow-hidden">
          ...
          <CardContent className="flex-1 overflow-y-auto scrollbar-thin scrollbar-track-slate-900/50 scrollbar-thumb-cyan-400/50">
